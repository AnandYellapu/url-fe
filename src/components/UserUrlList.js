...
//   const [readMoreUrl, setReadMoreUrl] = useState(null);
...
//     try {
//       await axios.delete(`http://localhost:6060/api/urls/urls/${deleteUrlId}`);
...
//       await axios.delete('http://localhost:6060/api/urls/bulk', { data: { urlIds: selectedUrls } });
...
import React, { useState, useEffect } from 'react';
import axios from 'axios';
import { IconButton, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Typography, Snackbar, Tooltip, Checkbox, Button, TextField, FormControl, InputLabel, Select, MenuItem, Modal } from '@mui/material';
import { Delete, FileCopy, Search } from '@mui/icons-material';
import { RingLoader } from 'react-spinners';
import Pagination from '../pages/Pagination';
import ConfirmationDialog from '../pages/ConfirmationDialog';
