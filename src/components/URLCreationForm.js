...
import { Link } from 'react-router-dom';
import { IoCopyOutline } from 'react-icons/io5';
import { Snackbar, Button, TextField, Grid, Paper, Typography, Divider, Box, MenuItem, Select, FormControl, InputLabel, CircularProgress } from '@mui/material';
import MuiAlert from '@mui/material/Alert';
import { styled } from '@mui/system';
import { QRCodeSVG } from 'qrcode.react';
import Autocomplete from '@mui/material/Autocomplete';
...
const StyledCopyIcon = styled(IoCopyOutline)({
  fontSize: '1.5rem',
  cursor: 'pointer',
  transition: 'transform 0.2s, color 0.2s',
  '&:hover': {
...
const URLCreationForm = () => {
  ...
  return (
    <Box sx={{ bgcolor: '#fff', color: '#000', minHeight: '100vh', p: 3 }}>
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <StyledPaper>
            <Typography variant="h5" gutterBottom>
